...
int main()
{
    ...
    cout << endl << sum << endl;
    sum = 0.0;
    cout << "F1: " << count_shennon(n, real_f1_propabilities) << endl;
    for (int i = 0; i < n; i++)
    {
    ...
    sum = 0.0;
    cout << "F2: " << count_shennon(n, real_f2_propabilities) << endl;

    cout << "PAIR OF SYMBOLS:" << endl;
    cout << "F1: " << count_pairs(n, size, mas, f1_file) << endl;
    cout << "F2: " << count_pairs(n, size, mas, f2_file) << endl;
}
